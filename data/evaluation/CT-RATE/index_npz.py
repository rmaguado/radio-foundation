"""
Indexing script for evaluation with CT-RATE dataset.
"""
...
from data.evaluation.base import NpzEvalBase, NpzProcessorBase
...
def main(args):
    ...
    database = NpzEvalBase(config)
    processor = NpzProcessorBase(config, database)
