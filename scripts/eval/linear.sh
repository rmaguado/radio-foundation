...
export PYTHONPATH=.
torchrun --nproc_per_node=2 ./dinov2/eval/linear.py \
    --config-file ./runs/imagenet1k_vits_reg4/config.yaml \
    --pretrained-weights ./runs/imagenet1k_vits_reg4/eval/training_499999/teacher_checkpoint.pth \
    --output-dir ./runs/imagenet1k_vits_reg4/eval/training_499999/linear \
