"""
Indexing script for evaluation with AUSTRALIA dataset.
"""
...
from data.evaluation.base import NiftiEvalBase, NiftiProcessorBase
...
def main(args):
    dataset_name = "Australia_3D_all"
    db_name = "Australia_eval"
