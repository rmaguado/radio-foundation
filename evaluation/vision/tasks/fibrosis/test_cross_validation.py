...
def get_datasets(args, label):
    ...
    test_embeddings_path = os.path.join(
        project_path,
        "evaluation/cache/Australia_eval",
        args.run_name,
        args.checkpoint_name,
    )
    ...
    train_labels_path = os.path.join(
        project_path, "evaluation/tasks/fibrosis/labels_osic.csv"
    )
    test_labels_path = os.path.join(
        project_path, "evaluation/tasks/fibrosis/labels_australia.csv"
    )

    train_dataset = FibrosisDataset(
